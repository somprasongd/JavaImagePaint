...
public abstract class AnnotationObject {
    ...
    private float alpha;
    private boolean ispublic_view;

    public AnnotationObject() {

    }

    public AnnotationObject(Color color) {
        this(color, null, false);
    }

    public AnnotationObject(Color color, Point2D location) {
        this(color, location, false);
    }

    public AnnotationObject(Color color, Point2D location, boolean antialiased) {
        this(color, location, antialiased, 1.0f);

    }

    public AnnotationObject(Color color, Point2D location, boolean antialiased, float alpha) {
    ...
    protected Point2D getStartDragLoc() {
        return startDrag;
    }
    ...
    public abstract AnnotationObject createCopy(int xOffset, int yOffset);

    public abstract String getInfo();

    public abstract Font getTextFont();

    public abstract String getTextNote();
